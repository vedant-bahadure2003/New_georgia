...
const KeyFacts = () => {
  const facts = [
    { icon: keyfacts1, number: 8, text: "No. of Faculties" },
    { icon: keyfacts2, number: 2500, text: "No. of Students" },
    { icon: keyfacts3, number: 4, text: "No. of Departments" },
  ...
  return (
    <div className="flex flex-col items-start lg:w-[95%] lg:mx-auto ml-3   py-4 ">
      ...
      <h2 className="text-[22px] lg:text-[28px] font-[700] mb-6 text-[#C7183A]">
        Key Facts About Bukhara State Medical Institute
      </h2>
