...
import fergana from "../../../../public/bannerImg/Fergana medical institute of public helath final 1.webp";
const navLinks = [
  { name: "Overview", link: "/fergana-medical-institute-of-public-health" },
  {
    name: "Courses & Fees",
    link: "/fergana-medical-institute-of-public-health/courses-and-fees",
  },
  {
    name: "Admission",
    link: "/fergana-medical-institute-of-public-health/admission",
  },
];
    ...
    <div className="absolute top-20 sm:top-[90px] text-white font-semibold px-4 sm:px-[170px] text-xs sm:text-sm">
      <p>
        ...
        {pathSegments.map((crumb, index) => {
          ...
          if (crumb === "fergana-medical-institute-of-public-health")
            breadcrumbLabel = "Fergana Medical Institute of Public Health";
...
const HeroSection = ({ headingTitle }) => {
  ...
  let title;
  if (headingTitle) {
    title = `Fergana Medical Institute of Public Health- ${headingTitle}`;
  } else if (pathname.includes("/courses-and-fees")) {
    title = "Fergana Medical Institute of Public Health - Courses & Fees 2025";
  } else if (pathname.includes("/admission")) {
    title =
      "Fergana Medical Institute of Public Health - Admission Process 2025";
  } else {
    title = "Fergana Medical Institute of Public Health";
  }
