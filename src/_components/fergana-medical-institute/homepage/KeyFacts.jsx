...
const KeyFacts = () => {
  const facts = [
    { icon: keyfacts1, number: 5, text: "No. of Faculties" },
    { icon: keyfacts2, number: 19000, text: "No. of Students" },
    { icon: keyfacts3, number: 19, text: "No. of Departments" },
    { icon: keyfacts4, number: "15:1", text: "Student-Faculty Ratio" },
  ];
  ...
  return (
    <div className="flex flex-col items-start lg:w-[95%] lg:mx-auto ml-3   py-4 ">
      ...
      <h2 className="text-[22px] lg:text-[28px] font-[700] mb-6 text-[#C7183A]">
        Key Facts about Fergana Medical Institute of Public Health
      </h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 w-full">
        {facts.map((fact, index) => (
          ...
          >
            ...
            {/* Description */}
            <p className="text-[14px] sm:text-[16px] text-gray-700 text-center">
              {fact.text}
            </p>
          </div>
        ))}
