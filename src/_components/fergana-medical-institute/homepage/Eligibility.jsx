  ...
  return (
    <div className="flex flex-col p-2 ">
      ...
      <h2 className="text-[22px] lg:text-[28px] font-bold text-[#C7183A]">
        Eligibility Criteria for Fergana Medical Institute of Public Health
      </h2>
      <p className="text-[14px] sm:text-[16px] font-[550]">
        Indian students must fulfill the following criteria to seek admission to
        the MBBS program at Fergana Medical Institute of Public Health:
      </p>
      {/* Eligibility List */}
      <div className="text-[14px] sm:text-[16px] ml-1 p-2 py-4 bg-[#FFF9EA] flex flex-col gap-4">
