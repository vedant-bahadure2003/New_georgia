...
const KeyFacts = () => {
  const facts = [
    { icon: keyfacts1, number: 9, text: "No. of Faculties" },
    { icon: keyfacts2, number: 10000, text: "No. of Students" },
    { icon: keyfacts3, number: "10+", text: "No. of Departments" },
    { icon: keyfacts4, number: "2:1", text: "Student-Faculty Ratio" },
  ];
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 w-full">
        {facts.map((fact, index) => (
          ...
          >
            ...
            {/* Number */}
            <h3 className="text-lg sm:text-2xl font-bold text-[#C7183A] mt-6">
              {fact.number}
            </h3>
