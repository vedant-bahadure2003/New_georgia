...
const KeyFacts = () => {
  const facts = [
    ...
    { icon: keyfacts2, number: 3915, text: "No. of Students" },
    { icon: keyfacts3, number: 38, text: "No. of Departments" },
    { icon: keyfacts4, number: "10:1", text: "Student-Faculty Ratio" },
  ];
  ...
  return (
    <div className="flex flex-col items-start lg:w-[95%] lg:mx-auto ml-3   py-4 ">
      ...
      <h2 className="text-[22px] lg:text-[28px] font-[700] mb-6 text-[#C7183A]">
        Key Facts About Tashkent Pediatric Medical Institute{" "}
      </h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 w-full">
        {facts.map((fact, index) => (
          ...
          >
            ...
            {/* Description */}
            <p className="text-[14px] sm:text-[16px] text-black text-center">
              {fact.text}
            </p>
          </div>
        ))}
