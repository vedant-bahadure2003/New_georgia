...
import tashkentpediatric from "../../../../public/bannerImg/Tashkent Pediatric Medical Institute final 1.webp";
const navLinks = [
  { name: "Overview", link: "/tashkent-pediatric-medical-institute" },
  {
    name: "Courses & Fees",
    link: "/tashkent-pediatric-medical-institute/courses-and-fees",
  },
  {
    name: "Admission",
    link: "/tashkent-pediatric-medical-institute/admission",
  },
];
      ...
      <p>
        ...
        {isSpecialPage && (
          <span>
            {" / "}
            <Link
              href="/tashkent-pediatric-medical-institute"
        ...
        {pathSegments.map((crumb, index) => {
          ...
          if (crumb === "tashkent-pediatric-medical-institute")
            breadcrumbLabel = " Tashkent Pediatric Medical Institute";
...
const HeroSection = ({ headingTitle }) => {
  ...
  let title;
  if (headingTitle) {
    title = `Tashkent Pediatric Medical Institute - ${headingTitle}`;
  } else if (pathname.includes("/courses-and-fees")) {
    title = "Tashkent Pediatric Medical Institute - Courses & Fees";
  } else if (pathname.includes("/admission")) {
    title = "Tashkent Pediatric Medical Institute - Admission Procedure";
  } else {
