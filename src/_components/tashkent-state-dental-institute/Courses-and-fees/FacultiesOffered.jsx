    ...
    <div className="lg:w-[95%] lg:mx-auto">
      <div className="w-full px-4 sm:px-0 py-6">
        <h2 className="text-[22px] lg:text-[28px] font-[700] text-[#C7183A] mb-4">
          Faculties at Tashkent State Dental Institute
        </h2>
        <p className="text-[14px] sm:text-[16px]  ">
          <span className="font-bold">Tashkent State Dental Institute</span>{" "}
          offers a diverse range of faculties, providing a comprehensive
