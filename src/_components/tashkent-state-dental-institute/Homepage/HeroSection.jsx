...
import tashkentdental from "../../../../public/bannerImg/Tashkent state dental institute final 1.webp";
const navLinks = [
  { name: "Overview", link: "/tashkent-state-dental-institute" },
  {
    name: "Courses & Fees",
    link: "/tashkent-state-dental-institute/courses-and-fees",
  },
  {
    name: "Admission",
    link: "/tashkent-state-dental-institute/admission",
  },
];
      ...
      <p>
        ...
        {isSpecialPage && (
          <span>
            {" / "}
            <Link
              href="/tashkent-state-dental-institute"
        ...
        {pathSegments.map((crumb, index) => {
          ...
          if (crumb === "tashkent-state-dental-institute")
            breadcrumbLabel = " Tashkent State Dental Institute";
...
const HeroSection = ({ headingTitle }) => {
  ...
  let title;
  if (headingTitle) {
    title = `Tashkent State Dental Institute - ${headingTitle}`;
    ...
    title = "Tashkent State Dental Institute - Admission Procedure";
  } else {
